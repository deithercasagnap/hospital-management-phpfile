...
<?php
    ...
    for ($a = 0; $rowcount > 0; $a++){
        ...
        if($affectedRow == 0){
            ...
            $sql="INSERT INTO doc_reg(doctor_number, first_name, last_name, qualification, dr_address, phone_number, salary, date_hired) 
            VALUES ('".$doctorNumber. "','".$firstName . "','" . $lastName . "','" . $qualification. "','". $address . "','" . $phoneNumber . "','" . $salary . "','". $dateHired . "')";
