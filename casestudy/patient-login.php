                    ...
                    <div class="card row">
                        <div class="">
                            ...
                            <div class="d-flex justify-content-center mt-4">
                                <img src="images\patients.jpg" alt="" width="120" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">    
                            </div>
                            <h6 class="text-center fw-bold fs-5 ms-2">Hi, There! Let's go, prioritize our health.</h6>
                            ...
                            <div class="row d-flex justify-content-center mb-3">
                                ...
                                <div class="col-11  m-2 d-flex justify-content-center mt-3">
                                    <div class="row">
                                        ...
                                        <input class="col rounded-4 border border-none p-2 ps-3 fs-6" style="width:20rem;" type="text" placeholder="Patient's Number">
                                    </div>
                                </div>
                                ...
                                <div class="col-11 d-flex justify-content-center">
                                    <p class="text-center ps-3"><a href="#loginpage">Forgot Password?</a></p>
                                </div>
                                <div class="col-11 m-2 d-flex justify-content-center">
                                    <p class="text-center ps-3">By logging in, you agree to the <span id="span">Terms of Conditions</span> and <span id="span">Privacy Policy</span>  of <a href="#loginpage">USTP-HMS</a>.</p>
                                </div>

                                <div  class="col-11 d-flex justify-content-center mb-2">
                                    <a id="login-button" class="ms-3 rounded-5 border border-success p-2 fw-bold fs-5 text-center" style="width:12rem" href="patient-page.php">Log In</a>
                                </div>

                                <div class="col-11 m-2 d-flex justify-content-center">
                                    <p class="text-center ps-3 mt-2">Don't have an account?  <a href="#loginpage"> Sign-Up</a>.</p>
                                </div>
