...
<head>
    ...
    <link rel="stylesheet" href="doctor-landingPage-style.css">
            ...
            <div class="offcanvas offcanvas-start text-bg-white" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#personal-health-record">Patient's Personal Health Record</a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            My Patients</a>
                                <ul class="dropdown-menu dropdown-menu-white">
                                    <li><a class="dropdown-item" href="#medical-record1">Checked-up</a></li>
                                    <li><a class="dropdown-item" href="#admissions">Admitted</a></li>
                                    <li><a class="dropdown-item" href="#surgeries">Surgery</a></li>
                                </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            Rooms</a>
                                <ul class="dropdown-menu dropdown-menu-white">
                                    <li><a class="dropdown-item" href="#rooms1">Vacant</a></li>
                                    <li><a class="dropdown-item" href="#rooms1">Occupied</a></li>
                                </ul>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="login-doctor.php">Log out</a>
                        </li>
...
<div id="personal-health-record" class="d-flex justify-content-center">
        <div class="container border border-info m-5">
            <div class="m-3">
                <h5 id="personal-health-record-text" class="text-success">Patient's Personal Health Record</h5>
                <div class="" style="width: 470px;">
                    <div class="row d-flex align-items-center">
                        ...
                        <a id="search-button" class="ms-3 rounded-4 border border-danger fw-bold fs-5 text-center text-decoration-none" style="width:12rem" href="index.html">Search</a>
    ...
    <div id="medical-record1"  class="d-flex justify-content-center">
        <div class="container border border-info m-5">
            ...
            <div id="check-ups" class="card m-3">
                <div class="m-3">
                    <h5 class="bg-success text-white p-2">History of Checked-up Patients</h5>
                </div>

                <div class="">
                    <h4 class="text-warning text-center">List of checked-up patients will appear here.</h4>
                </div>
            ...
            <div id="admissions" class="card m-3">
                <div class="m-3">
                    <h5 class="bg-success text-white p-2">History of Admitted Patients</h5>
                </div>
                
                <div class="">
                    <h4 class="text-warning text-center">List of admitted patients will appear here.</h4>
                </div>
            </div>

            <div id="surgeries" class="card m-3">
                <div class="m-3">
                    <h5 class="bg-success text-white p-2">History of Operated Patients</h5>
                </div>
                
                <div class="">
                    <h4 class="text-warning text-center">List of operated patients will appear here.</h4>
                </div>
            </div>

            <div id="discharged" class="card m-3">
                <div class="m-3">
                    <h5 class="bg-success text-white p-2">History of discharged Patients</h5>
                </div>
                
                <div class="">
                    <h4 class="text-warning text-center">List of discharged patients will appear here.</h4>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="rooms1"  class="d-flex justify-content-center">
        <div class="container border border-info m-5">
            <div class="m-3">
                <h5 id="rooms" class="text-success">Rooms</h5>
                <h6 class="text-danger fst-italic fw-light">This shows all the vacant and occupied rooms.</h6>
            </div>

            <div id="check-ups" class="card m-3">
                <div class="m-3">
                    <h5 class="bg-success text-white p-2">Vacant</h5>
                </div>

                <div class="">
                    <h4 class="text-warning text-center">Vacant room number will appear here.</h4>
                </div>
            ...
            <div id="admissions" class="card m-3">
                <div class="m-3">
                    <h5 class="bg-success text-white p-2">Occupied</h5>
                </div>
                
                <div class="">
                    <h4 class="text-warning text-center">Occupied room number will appear here.</h4>
                </div>
            </div>
