...
<head>
    ...
    <title>ON-CALL DOCTOR DATA ENTRY PAGE</title>
</head>
<body>
        ...
        <div class="col-10 bg-warning pt-2 pb-2 rounded-3">
          <div class="card">
            <div class="card-body justify-content-center align-items-center">
                ...
                <h6 class="fw-bold fs-5 mb-4 pt-2 pb-2 bg-info text-center rounded-2 text-danger ">On-call Doctor Registration Form</h3>

                <form action="verify-oncall-doctor-data.php"  method="post">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-10 justify-content-center">
                            <div class="row">
                                <div class="col mb-2">
                                    <div class="form-outline">
                                        <label class="form-label" for="feespercall">Fees per call</label>
                                        <input type="number" name="feespercall" class="form-control" />
                                    </div>
                                </div>  
                                <div class="col mb-2">
